...
class DisputeAcceptScreen extends StatefulWidget {
  String? title;

  DisputeAcceptScreen({this.title});

  @override
  _DisputeAcceptScreenState createState() => _DisputeAcceptScreenState();
}

class _DisputeAcceptScreenState extends State<DisputeAcceptScreen> {
  @override
            ...
            children: [
              ...
              Align(
                ...
                child: HelperUtility.autoResizetextWidget(
                    text: Strings.addAmount, fontSize: Dimens.font_18),
              ),
              SizedBox(
